...
public class CodeMsg {
    ...
    //登录模块 5002XX
    public static final CodeMsg SESSION_ERROR = new CodeMsg(500210, "Session不存在或者已经失效,请重新登陆");
    ...
    //秒杀模块 5005XX
    public static final CodeMsg SECKILL_OVER = new CodeMsg(500500, "商品已将秒杀完毕");
    ...
    public static final CodeMsg VERIFYCODE_ERROE = new CodeMsg(500502, "验证码错误");
